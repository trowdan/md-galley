// Tiny YAML front-matter parser. Scope is intentionally narrow: only the shape
// produced by this project's chapter files (key: scalar, key: [scalar, ...]).
// Returns body, parsed front matter object, and the source line on which body starts.
