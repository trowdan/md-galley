...
//     notes/
//       <file path>.json      one JSON array per source file
//       <subdir>/<name>.md.json
//
// The directory tree mirrors the workspace tree, so files are easy to
// diff, grep, and commit to source control if the user wants to.
//
...
export class NotesDiskPersister {
     ...
     *  BEFORE any file is loaded, so the document view never has to
