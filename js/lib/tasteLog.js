...
//
// Purpose: future agents (a drafter that proposes notes, a memory agent
// that learns the reviewer's recurring concerns) read this file as ground
// truth. The reviewer's taste is a first-class artefact, not a vibe inside
// a vendor's model.
//
...
function describeAnchor(ann) {
    if (ann.scope === "document") return "whole-document";
